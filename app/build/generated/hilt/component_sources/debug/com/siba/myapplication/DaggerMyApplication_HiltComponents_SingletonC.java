...
import com.siba.myapplication.di.LocalDbModule_ProvidesNewsDaoFactory;
import com.siba.myapplication.di.LocalDbModule_ProvidesUserDatabaseFactory;
import com.siba.myapplication.di.NetworkModule;
import com.siba.myapplication.di.NetworkModule_ProvideApiServiceFactory;
import com.siba.myapplication.di.NetworkModule_ProvideOkHttpClientFactory;
import com.siba.myapplication.di.NetworkModule_ProvideRetrofitFactory;
import com.siba.myapplication.roomdb.NewsDatabase;
import com.siba.myapplication.ui.MainActivity;
import com.siba.myapplication.ui.NewsViewModel;
import com.siba.myapplication.ui.NewsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  public static final class Builder {
    ...
    public Builder localDbModule(LocalDbModule localDbModule) {
      Preconditions.checkNotNull(localDbModule);
      return this;
    }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private NewsRepository newsRepository() {
      return new NewsRepository(singletonCImpl.provideApiServiceProvider.get());
    }

    private LocalNewsRepository localNewsRepository() {
      return new LocalNewsRepository(singletonCImpl.providesNewsDaoProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.siba.myapplication.ui.NewsViewModel", ((Provider) newsViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.siba.myapplication.ui.NewsViewModel 
          return (T) new NewsViewModel(viewModelCImpl.newsRepository(), viewModelCImpl.localNewsRepository());
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private Provider<NewsDatabase> providesUserDatabaseProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam,
      ...
      this.providesUserDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<NewsDatabase>(singletonCImpl, 4));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.siba.myapplication.data.remote.ApiService 
          ...
          case 3: // com.siba.myapplication.data.local.dao.NewsDao 
          return (T) LocalDbModule_ProvidesNewsDaoFactory.providesNewsDao(singletonCImpl.providesUserDatabaseProvider.get());

          case 4: // com.siba.myapplication.roomdb.NewsDatabase 
          return (T) LocalDbModule_ProvidesUserDatabaseFactory.providesUserDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
